 ...
 * 先后：TA 的来信（信箱）> 驾校 > 旅行心愿（想去哪里 / 还差什么，TRV-06，来源 journey/travelPlan/wishNote）> 系统提示（世界正在更新）；
 * 同一种里保持来的先后。收起 / 展开在 ./StatusPanel。
...
export const NOTE_KINDS = ["mail", "school", "wish", "system"] as const;
