...
| 出发/到站/改行程 | `queryKeys.home`、`["transport"]`、`["food","recommendations"]`（行程版本变化使推荐待复核）、`["communicator"]` |
...
迁移编号区间：每个模块只在自己的区间建文件；`0001–0099` 平台共享（框架窗口）。已用：0001、0010、0020、0100、0150、0160、0200、0210、0220、0300、0400、0410、0450、0460、0500、0600、0650、0660、0670、0700、0800、0900、1000、1020、1100、1110、1120、1200、1210、1300、1400、1410、1420、1430。`1300–1399` 为宠物自主世界（`app/web_agent/`），`1400–1499` 为证件与驾考（`app/web_credentials/`、`app/web_driving/`）。
